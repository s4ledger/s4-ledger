...
const searchIndex = [
    ...
    // ═══ DEMO APP — ILS WORKSPACE (18 Tools) ═══
    { title: 'ILS Workspace — Unified Command Center', tags: 'ILS workspace command center dashboard unified interface all tools 18 tools defense logistics management platform', page: 'Demo App', url: 'demo-app' },
