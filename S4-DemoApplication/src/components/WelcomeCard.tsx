    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50 animate-fadeIn">
      <div className="bg-surface border border-border rounded-card p-8 max-w-lg w-full mx-4 animate-slideUp">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white">Welcome, SSgt. Mitchell</h2>
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-start gap-3 bg-white/5 rounded-lg p-3">
            ...
            <div>
              <p className="text-white text-sm font-medium">Blockchain-Verified Records</p>
              <p className="text-steel text-xs">Every deliverable is anchored to the XRP Ledger for tamper-proof accountability.</p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-white/5 rounded-lg p-3">
            <i className="fas fa-brain text-accent mt-0.5"></i>
            <div>
              <p className="text-white text-sm font-medium">AI-Assisted Analysis</p>
          ...
          <div className="flex items-start gap-3 bg-white/5 rounded-lg p-3">
            ...
            <div>
              <p className="text-white text-sm font-medium">One-Click PDF Reports</p>
