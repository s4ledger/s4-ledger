...
export const sampleData: DRLRow[] = [
  ...
  // ── PS-driven milestone-linked DRL rows ──────────────────────────
  {
    id: 'DRL-015',
    vesselId: 'APL-101',
    title: "Builder's Trial Readiness Report (APL-101 — 40ft Patrol Boat)",
    ...
    received: 'No',
    calendarDaysToReview: null,
    notes: 'Due date driven by APL-101 BT milestone in Program Schedule. Will update when PS is synced.',
    status: 'pending',
    responsibleParty: 'Shipbuilder',
    govNotes: '',
  ...
  },
  {
    id: 'DRL-016',
    vesselId: 'APL-101',
    title: 'Pre-Delivery ILS Inspection Checklist (APL-101 — 40ft Patrol Boat)',
    ...
    received: 'No',
    calendarDaysToReview: null,
    notes: 'Due date computed from APL-101 BT milestone minus 14 days. Requires PS sync to calculate.',
    status: 'pending',
    responsibleParty: 'Shipbuilder',
    govNotes: '',
    shipbuilderNotes: '',
  },
  {
    id: 'DRL-017',
    vesselId: 'APL-101',
    title: 'Ship Acceptance Document (APL-101 — 40ft Patrol Boat)',
  ...
  },
  {
    id: 'DRL-018',
    vesselId: 'APL-101',
    title: 'As-Built Drawing Package (APL-101 — 40ft Patrol Boat)',
  ...
  },
  {
    id: 'DRL-019',
    vesselId: 'YRBM-51',
    title: 'Delivery Documentation Package (YRBM-51 — 11m RHIB)',
